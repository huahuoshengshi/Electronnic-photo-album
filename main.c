...
//		delay_ms(200);				  
//	}  	 
// 	Show_Str(60,50,200,16,"STM32RCT6核心板",16,0);				    	 
...
//	Show_Str(60,130,200,16,"正点原子@ALIENTEK",16,0);				    	 
	Show_Str(60,150,200,16,"2020年10月15日",16,0);
 	while(f_opendir(&picdir,"0:/PICTURE"))//打开图片文件夹
 	{	    
		Show_Str(60,170,240,16,"PICTURE Folder Error!",16,0);
		delay_ms(200);				  
	...
	totpicnum=pic_get_tnum("0:/PICTURE"); //得到总有效文件数
 	...
 	{	    
		Show_Str(60,170,240,16,"No PICTURE Folder!",16,0);
		delay_ms(200);				  
		LCD_Fill(60,170,240,186,WHITE);//清除显示	     
		delay_ms(200);				  
	}
	...
	picfileinfo.lfname=mymalloc(picfileinfo.lfsize);	//为长文件缓存区分配内存
 	...
 	{	    
		Show_Str(60,170,240,16,"Memory allocation failure!",16,0);
		delay_ms(200);				  
		LCD_Fill(60,170,240,186,WHITE);//清除显示	     
		delay_ms(200);				  
	}  	
	...
	Show_Str(60,170,240,16,"START...",16,0); 
	delay_ms(1500);
	piclib_init();										//初始化画图	   	   
	curindex=0;											//从0开始显示
